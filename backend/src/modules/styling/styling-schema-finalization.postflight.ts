...
export const stylingSchemaFinalizationPostflightRowSchema = z.object({
  ...
  receipt_20260824_absent: z.literal(true),
...
export const stylingSchemaFinalizationPostflightSql = `
  select
    exists (
      select 1
